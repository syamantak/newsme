                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ url('customer/update') }}">
                        ...
                        <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                            <label for="total" class="col-md-4 control-label">Address</label>

                            <div class="col-md-6">
                                <input id="total" type="text" class="form-control" name="address" value="{{ $customer->address  }}" required>
                        ...
                        <div class="form-group{{ $errors->has('mobile') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="mobile" type="text" class="form-control" name="mobile" value="{{ $customer->mobile }}" required>
